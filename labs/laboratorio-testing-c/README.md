...
> R:No coincide el total que nos da el calculo, el total es:
...
> R:Inicializa el carrito en 0 y es importante por que sino inicializa en basura
...
> R:Aparece en la linea 24, esa linea solo suma el precio de cada producto sin importar la cantidad comprada
...
> R:Si aparecen en las lineas, no se ejecuta por que no llaman a carrrito descuento
